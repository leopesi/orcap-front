                ...
                <div class="col-sm-6">
                  <div class="form-group mb-3">
                    ...
                    <input
                      ...
                      type="number"
                      @keyup="
                        installment_credit_card = changeInstallment(
                          $event,
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="row">
                    <div
                      class="col-sm-3"
                      v-for="i in parseInt(installment_credit_card.length)"
                      :key="i"
                    >
                      <div class="row pb-4 align-items-center">
                        ...
                        <div class="col-sm-8">
                          <input
                            class="form-control"
                            v-model="installment_credit_card[parseInt(i)]"
                            type="number"
                          />
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="row">
                    <div
                      class="col-sm-3"
                      v-for="i in parseInt(by_logist.length)"
                      :key="i"
                    >
                      <div class="row pb-4 align-items-center">
                        <div class="col-sm-2 text-right px-0">
                ...
                <div class="col-sm-6">
                  <div class="form-group mb-3">
                    ...
                    <input
                      ...
                      @keyup="
                        by_financial = changeInstallment($event, by_financial)
                      "
                      @change="
                        by_financial = changeInstallment($event, by_financial)
                      "
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="row">
                    <div
                      class="col-sm-3"
                      v-for="i in parseInt(by_financial.length)"
                      :key="i"
                    >
                      <div class="row pb-4 align-items-center">
                        <div class="col-sm-2 text-right px-0">
                        ...
                        <div class="col-sm-8">
                          <input
                            class="form-control"
                            v-model="by_financial[parseInt(i)]"
                            type="number"
                          />
                        </div>
                      </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group mb-3">
                    ...
                    <input
                      ...
                      @keyup="
                        by_financial_down_payment = changeInstallment(
                          $event,
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="row">
                    <div
                      class="col-sm-3"
                      v-for="i in parseInt(by_financial_down_payment.length)"
                      :key="i"
                    >
                      <div class="row pb-4 align-items-center">
                        <div class="col-sm-2 text-right px-0">
                        ...
                        <div class="col-sm-8">
                          <input
                            class="form-control"
                            v-model="by_financial_down_payment[parseInt(i)]"
                            type="number"
                          />
                        </div>
                      </div>
