      ...
      <div class="card">
        ...
        <ul class="nav nav-pills pt-2">
          ...
          <li class="nav-item">
            <a
              :class="
                'nav-link ' + (this.actualTab == 'brands' ? ' active' : '')
              "
              aria-current="page"
              @click="actualTab = 'brands'"
            >
              {{ $t('brands') }}
            </a>
          </li>
          ...
          <li class="nav-item">
            <a
              :class="
                'nav-link ' + (this.actualTab == 'manpowers' ? ' active' : '')
              "
              aria-current="page"
              @click="actualTab = 'manpowers'"
            >
              {{ $t('man_power') }}
            </a>
          </li>
          ...
          <li class="nav-item">
            <a
              :class="
                'nav-link ' + (this.actualTab == 'financials' ? ' active' : '')
              "
              aria-current="page"
              @click="actualTab = 'financials'"
            >
              {{ $t('financial') }}
            </a>
          </li>
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <FinancialsTab
            ...
            :form="this.form"
            :brands="this.brands"
            v-if="this.actualTab == 'financials'"
          />
        </div>
      </div>
    </div>
...
export default {
  ...
  props: { id: String },
  i18n: { messages },
  components: { BrandsTab, ManPowersTab, FinancialsTab },
  data() {
    return {
      form: {
