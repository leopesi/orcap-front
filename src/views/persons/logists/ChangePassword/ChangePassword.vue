			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input class="form-control" id="actual_password" v-model="form.actual_password" type="password" />
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input class="form-control" id="re_new_password" v-model="form.re_new_password" type="password" />
					</div>
				</div>
			</div>
		</Form>
