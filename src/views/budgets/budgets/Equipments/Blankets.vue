		...
		methods: {
			...
			setData() {
				...
				if (this.blankets[id] && this.blankets[id].equipments) {
					const profit_margin = Methods.fixNumber(this.blankets[id].equipments.profit_margin)
					const cost = Methods.fixNumber(this.blankets[id].equipments.cost)
					...
					const man_power_profit_margin = Methods.fixNumber(this.blankets[id].equipments.man_power_profit_margin)
					const man_power_cost = Methods.fixNumber(this.blankets[id].equipments.man_power_cost)
					...
					this.form.equipments[this.index].final_price = price_with_discount * this.m2_facial + man_power_price - discount
