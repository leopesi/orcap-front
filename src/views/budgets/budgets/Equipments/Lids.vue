		...
		methods: {
			...
			setData() {
				if (this.lids[this.value] && this.lids[this.value].equipments) {
					...
					const man_power_profit_margin = parseFloat(this.lids[this.value].equipments.man_power_profit_margin)
					const man_power_cost = parseFloat(this.lids[this.value].equipments.man_power_cost)
